...
HD_PWD='D:/Users/matias/Proyectos/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log semaforoTimer.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source semaforoTimer.tcl
